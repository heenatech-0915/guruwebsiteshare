...
class ReagentDetailsPage extends StatelessWidget {
  ReagentDetailsPage({Key? key}) : super(key: key) {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: InkWell(
                                onTap: () {
                                  Get.delete(tag: "DetailsPageController");
                                  Get.to(RelatedReagentsPage(
                                      relatedReagents: detailsController
                                          .productDetail
                                          .value
                                          .data!
                                          .linkedProducts));
