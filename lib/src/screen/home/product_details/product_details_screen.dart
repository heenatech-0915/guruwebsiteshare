...
import 'package:cpcdiagnostics_ecommerce/src/screen/home/product_details/related_reagents_page.dart';
...
import 'package:cpcdiagnostics_ecommerce/src/controllers/details_screen_controller.dart';
import 'package:cpcdiagnostics_ecommerce/src/controllers/favourite_controller.dart';
...
import 'package:cpcdiagnostics_ecommerce/src/screen/home/product_details/details_image_view_screen.dart';
...
import 'package:cpcdiagnostics_ecommerce/src/widgets/wholesale_data_widget.dart';
import '../../../utils/responsive.dart';
import '../../../widgets/button_widget.dart';
import '../../../widgets/loader/shimmer_details_page.dart';
import '../../dashboard/dashboard_screen.dart';
import 'brochure_pdf_page.dart';
import 'description_image_view.dart';
import 'product_description.dart';

class DetailsPage extends StatelessWidget {
  DetailsPage({Key? key}) : super(key: key) {
    _cartController.isAddingToCart.value = false;
  }
  int reagentId = 0;
  ...
  final sku = Get.parameters['sku'];

  @override
  Widget build(BuildContext context) {
    print("product id-->$productId");
    print("ordering-->${detailsController.ordering.value}");
          ...
          children: [
            Expanded(
              child: ListView(
                ...
                children: [
                  //image Slide
                  detailsController.ordering.value != 2
                      ? LimitedBox(
                          maxHeight: 200.h,
                          child: Stack(
...
/*                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                                            ...
                                                            return InkWell(
                                                              onTap: () {
                                                                _colorSelectionController
                                                                  ...
                                                                  index: index,
                                                                  colorName: detailsModel
                                                                      .data!
                                                                      .colors![
                                                                          index]
                                                                      .name
                                                                      .toString(),
                                                                  colorId: detailsModel
                                                                      .data!
                                                                      .colors![
                                                                          index]
                                                                      .id
                                                                ...
                                                                child:
                                                                  ...
                                                                  decoration:
                                                                    ...
                                                                    border:
                                                                        Border
                                                                            .all(
                                                                      color: Color(int.parse("0xff${detailsModel.data!.colors![index].hexCode.toString()}") ==
                                                                              AppThemeData
                                                                                  .colorWhite
                                                                          ? AppThemeData
                                                                              .colorBlack
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child: Obx(() => Container(
                                                                        decoration: BoxDecoration(
                                                                          color:
                                                                              Color(int.parse("0xff${detailsModel.data!.colors![index].hexCode.toString()}")),
                                                                          borderRadius:
                                                                              BorderRadius.all(
                                                                            Radius.circular(5.r),
                                                                          ),
                                                                        ...
                                                                        child: _colorSelectionController.selectedIndex.value == index
                                                                            ? Padding(
                                                                ...
                                                                itemBuilder:
                                                                  ...
                                                                  return Padding(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onTap:
                                                                          () {
                                                                        _colorSelectionController.changeAttrSelection(
                                                                            attrIndex:
                                                                                i,
                                                                            value:
                                                                                index);
                                                                        ...
                                                                        _colorSelectionController.insertAttrIdToList(
                                                                            id: detailsModel.data!.attributes![i].attributeValue![index].id!
                                                                                .toString(),
                                                                            index:
                                                                                i);
                                                                      },
                                                                      child:
                                                                        ...
                                                                        () =>
                                                                          ...
                                                                          decoration:
                                                                            ...
                                                                            border:
                                                                                Border.all(
                                                                              color: _colorSelectionController.selectedArray[i] == index ? const Color(0xffF51E46) : const Color(0xffF4F4F4),
                                                                            ),
                                                                            borderRadius:
                                                                                BorderRadius.all(
                                                                              Radius.circular(3.r),
                                                                    ...
                                                                    ? Obx(
                                                                        () =>
                                                                          ...
                                                                          children: [
                                                                            InkWell(
                                                                              onTap: () {
                                                                                Get.to(DescriptionImageViewScreen(
                                                                                  descriptionImage: detailsController.productDetail.value.data!.descriptionImages,
                                                                                ));
                                                                              },
                                                                              child: SizedBox(
                                                                                child: Padding(
                                                                                  ...
                                                                                  child: Image.network(
                                                                                    detailsModel.data!.descriptionImages![detailsController.pageView.value].toString(),
                                                                                    fit: BoxFit.fitWidth,
                                                                                  ),
                                                                                ),
                                                                              ),
                                  ...
                                  (detailsController.productDetail.value.data!
                                                      .ordering ==
                                                  1 ||
                                              detailsController.productDetail
                                                      .value.data!.ordering! >
                                                  2) &&
                                          detailsController.productDetail.value
                                              .data!.linkedProducts.isNotEmpty
                                      ? Container(
                                          alignment: Alignment.center,
                                          decoration: BoxDecoration(
                                            border: Border.all(
                                  ...
                                  detailsModel.data!.pdf!.isNotEmpty
                                      ? Container(
                                          alignment: Alignment.center,
                                          decoration: BoxDecoration(
                                            border: Border.all(
                            ...
                            Expanded(
                              child: InkWell(onTap: () {
                                if (detailsModel.data!.hasVariant!) {
                                  ...
                                  if (LocalDataHelper().getUserToken() ==
                                      null) {
                                    Get.toNamed(Routes.logIn,
                                        arguments: {'pop': true});
                                  } else {
                                ...
                                return Container(
                                  ...
                                  child: Padding(
                                    padding: EdgeInsets.all(4.r),
                                    child: !_cartController.isAddingToCart.value
                                        ? Row(
                                            mainAxisAlignment:
                                                MainAxisAlignment.center,
                                            children: [
