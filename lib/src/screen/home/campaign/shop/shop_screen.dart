...
class ShopScreen extends StatelessWidget {
  ...
  final ShopScreenController shopScreenController = Get.put(ShopScreenController());
  @override
  Widget build(BuildContext context) {
    return Obx(() => shopScreenController.visitShopModel.value.data != null
      ...
      appBar: isMobile(context)? AppBar(
        ...
        centerTitle: true,
        title: Text(
          shopScreenController.visitShopModel.value.data!.shop!.shopName.toString(),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                fit: BoxFit.cover,
                image: NetworkImage(
                  shopScreenController.visitShopModel.value.data!.shop!.image1905x350!.toString(),
                ),
              ),
            ),
            child: Column(
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Center(
                            child: Text(
                              shopScreenController.visitShopModel.value.data!.shop!.shopName
                                  .toString(),
                              style: TextStyle(
                          ...
                          Row(
                            ...
                            children: [
                              RatingBarIndicator(
                                rating: double.parse(
                                  shopScreenController.visitShopModel.value.data!.shop!.ratingCount
                                      .toString(),
                                ),
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            fit: BoxFit.cover,
                            image: NetworkImage(
                              shopScreenController.visitShopModel.value.data!.shop!.image82x82!
                                  .toString(),
                            ),
                          ),
                        ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Expanded(
                    child: TabBarView(
                      children: [
                        StoreScreen(visitShopModel: shopScreenController.visitShopModel.value),
                        CouponScreen(visitShopModel: shopScreenController.visitShopModel.value),
                        ProductScreen(visitShopModel: shopScreenController.visitShopModel.value),
                      ],
                    ),
                  )
                ],
